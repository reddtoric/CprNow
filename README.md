...
Chest compression-only CPR assistant for mobile. Assisting user with audio and visual cues in 2 button presses (3 clicks: App open, 'Start CPR Now' from checklist, 'Start' timer). Available for USA/Canada.
